...
from litex.boards.platforms import trellisboard
...
class EthernetSoC(BaseSoC):
    mem_map = {
        "ethmac": 0xa0000000,  # (shadow @0xa0000000)
    }
    ...
    def __init__(self, toolchain="diamond", **kwargs):
        ...
        self.add_wb_slave(mem_decoder(self.mem_map["ethmac"], self.mem_map["ethmac"] + 0x08000000), self.ethmac.bus)
        self.add_memory_region("ethmac", self.mem_map["ethmac"] | self.shadow_base, 0x4000)
        self.add_csr("ethmac")
